...
state = {
  ...
  morningAccounts: { latest:null, autoOpenedDay:0 }, # latest = exact completed-rollover account {day, openingBalance, closingBalance, income, expenses, oreMovement, production:{ore,items}, sales, losses:{ore,veins}, exceptions}; autoOpenedDay is the once-only presentation receipt.
