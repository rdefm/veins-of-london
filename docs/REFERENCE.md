...
**Signed off and implemented (ticket 03, combat-refining, 2026-09-19): `combat.turnCursor` below. Signed off (ticket 05, combat-refining, 2026-09-21): `combat.selection` below.** `combat.locationKey` below remains **DRAFT — pending sign-off** (ticket 01, combat-refining, 2026-09-19), needed before combat-refining ticket 10 can build against it. Additive/renaming only — no change to any formula, XP award, reward, or flee/item rule.
