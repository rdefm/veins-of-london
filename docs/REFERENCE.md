...
**Signed off and implemented (ticket 03, combat-refining, 2026-09-19): `combat.turnCursor` below.** Still **DRAFT — pending sign-off** (ticket 01, combat-refining, 2026-09-19) for the other two amendments below, needed before combat-refining tickets 05/07/10 can build against them. Additive/renaming only — no change to any formula, XP award, reward, or flee/item rule.
